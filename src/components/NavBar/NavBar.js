        ...
        <Navbar expand="xl" className=" shadow" fixed="top">
          ...
          <Modal show={showUserDataModal} onHide={() => setShowUserDataModal(false)}>
            ...
            <Modal.Footer className="d-flex justify-content-around">
              <Button variant="secondary" onClick={() => setShowUserDataModal(false)}>
                Close
              </Button>
...
//       Swal.fire("Passwords do not match ☹️");
//       return;
//     }

//     // Construct the request payload based on whether the password needs to be updated
//     const requestData = {
//       name,
//       email,
//     };
